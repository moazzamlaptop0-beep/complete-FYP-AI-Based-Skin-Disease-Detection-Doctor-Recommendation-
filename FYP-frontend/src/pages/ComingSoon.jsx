 ...
 * coming — and it is built entirely on the shared ui primitives, so it inherits
  ...
  return (
    <Card variant="elevated" padding="none" className="overflow-hidden">
      <EmptyState
        ...
        action={(
          <Button as={Link} to={backTo} variant="outline" leftIcon={<ArrowLeft className="h-4 w-4" />}>
            {backLabel}
          </Button>
        )}
      >
