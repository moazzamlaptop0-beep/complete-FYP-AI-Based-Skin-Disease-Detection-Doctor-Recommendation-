        ...
        <div className="rounded-card border border-subtle bg-surface-sunken p-4">
          <div className="flex flex-wrap items-start justify-between gap-3">
            <div className="min-w-0 flex-1">
              ...
              >
                <Zap aria-hidden="true" className="h-4 w-4 text-warning-600" />
                Express lane
              ...
              <p id={`${switchId}-help`} className="mt-1 text-body-sm text-muted">
                ...
                the usual 48, the invitation email is flagged priority, and your request sorts above
                routine ones.
              </p>
              {forced && (
                <p className="mt-1.5 text-caption text-subtle">
                  A {isCritical ? 'critical' : 'urgent'} score always uses this lane, so it cannot be
                  switched off here. You can still change every other part of the request.
                </p>
              )}
            </div>
